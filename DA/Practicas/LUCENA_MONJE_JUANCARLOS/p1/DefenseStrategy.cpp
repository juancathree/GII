...
float cellValue(int row, int col, int nCellsWidth, int nCellsHeight, float mapWidth, float mapHeight, List<Object*> obstacles, Defense* base) {
	int value = 0;
    float distance;
...
void DEF_LIB_EXPORTED placeDefenses(bool** freeCells, int nCellsWidth, int nCellsHeight, float mapWidth, float mapHeight
    ...
    int value = cellValue(29, 50, nCellsWidth, nCellsHeight, mapWidth, mapHeight, obstacles, (*currentDefense));
