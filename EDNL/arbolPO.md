...
Un **árbol completo** es un árbol con todos sus niveles llenos, con la posible excepción del nivel más bajo, al cuál sólo le pueden 
faltar nodos por la derecha.

Un **árbol parcialmente ordenado** (montículo) es un árbol completo en el que el valor en cualquier nodo es menor que el de todos sus 
descendientes, o sea, en un APO, para todo nodo X, el valor en el padre de X es menor o igual que el valor en X 
(con excepción de la raíz, que no tiene padre). 
...
template <typename T>
inline Apo<T>::Apo(size_t maxNodos) : nodos(new T[maxNodos]),
                                      maxNodos(maxNodos),
                                      ultimo(-1) {}
